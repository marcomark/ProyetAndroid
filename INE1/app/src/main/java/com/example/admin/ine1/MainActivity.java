...
public class MainActivity extends AppCompatActivity {
    ...
    private FrameLayoutLateral sifl;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // b1=(FloatingActionButton)findViewById(R.id.pink_icon);


        sifl = (FrameLayoutLateral)findViewById(R.id.scrimInsetsFrameLayout);
        ...
        ArrayAdapter<String> ndMenuAdapter = new ArrayAdapter<>(this,android.R.layout.simple_list_item_activated_1, opciones);
    ...
    public void listas(int tam) {
        ///lv1 = (ListView) findViewById(R.id.listView32);
